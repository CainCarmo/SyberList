            ...
            $cardsAnime .= '
                <div class="section__card">
                    ...
                    <div class="card__information">
                        ...
                        <span class="card__extra">' . EnumsSituation::ToggleSituation($cardsAnimeResponse->FK_SITUATION_ID) . '</span>
                    </div>
                </div>  
            ';
        }
            ...
            $cardsMovie .= '
                <div class="section__card">
                    ...
                    <div class="card__information">
                        ...
                        <span class="card__extra">' . EnumsSituation::ToggleSituation($cardsMovieResponse->FK_SITUATION_ID) . '</span>
                    </div>
                </div>
            ';
        }
...
?>
        ...
        <!-- Banner da Página -->
        <section id="banner">
            <img src="./Resources/Image/Background/戦争.png" alt="Banner Image">
            <header id="banner__user">
                <!-- Foto do Usuário -->
                <div id="user__icon">
                    <img src="./Resources/Image/Perfil/<?=$_SESSION["User"]["COVER"]?>" alt="Foto do Usuário">
                </div>
                ...
                <div id="user__info">
                    ...
                    <div id="info__situation--wrapper">
                        ...
                        <span id="sitation__text"><?=$situation?></span>
                    </div>
                </div>
        ...
        <main id="content">
            ...
            <div id="lists">
                ...
                <section class="section__lists" id="lists__anime">
                ...
                <header class="section__header">
                    <h2 class="header__title">
                        <i class="fa-solid fa-list"></i> - Listas Filmes/Séries
                    </h2>
                </header>
                <section class="section__lists" id="lists__movie">
                    <div class="lists__tabs">
